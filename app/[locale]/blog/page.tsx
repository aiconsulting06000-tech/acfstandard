  ...
  const articles: Article[] = [
    {
      ...
      date: "2026-02-15", category: t("blog.article1.category"), catColor: C.amber, readTime: "8 min",
      content: [
        ...
        { type: "p", text: t("pages.home.les_organisations_qui_attendent_la_mise_en_applica") },
    ...
    },
    {
      ...
      date: "2026-02-08", category: t("blog.article2.category"), catColor: C.green, readTime: "7 min",
      content: [
    ...
    },
    {
      ...
      date: "2026-01-29", category: t("blog.article3.category"), catColor: C.blue, readTime: "10 min",
      content: [
    ...
    },
    {
      ...
      content: [
        ...
        { type: "p", text: t("pages.home.la_couche_politique_transforme_les_principes_de_go") },
        ...
        { type: "p", text: t("pages.home.le_score_acf_mesure_précisément_cet_équilibre_entr") },
      ]
    },
    {
      ...
      content: [
        ...
        { type: "quote", text: t("pages.home.les_organisations_qui_gouvernent_leurs_agents_ia_n") },
        { type: "p", text: t("pages.home.le_score_acf_mesure_précisément_cet_équilibre_entr") },
      ]
    },
  ];
        ...
        <div style={{ maxWidth: 1320, margin: "0 auto", padding: "0 40px", width: "100%", display: "flex", alignItems: "center", justifyContent: "space-between" }}>
          <a href="/en/" style={{ display: "flex", alignItems: "center", gap: 12 }}>
            ...
            <div>
              ...
              <div style={{ fontFamily: "'JetBrains Mono', monospace", fontSize: 9, color: C.gray, letterSpacing: ".1em" }}>{t("pages.home.blog_recherche")}</div>
            </div>
          </a>
        ...
        <>
          ...
          <section style={{ paddingTop: 120, paddingBottom: 40, textAlign: "center" }}>
            <div style={{ maxWidth: 700, margin: "0 auto", padding: "0 40px" }}>
              <div className="fade-up"><Badge>{t("pages.home.blog_recherche")}</Badge></div>
              ...
              {filtered.map(a => (
                <article key={a.slug} onClick={() => { setActiveArticle(a.slug); window.location.hash = a.slug; }} style={{
                  ...
                  <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between" }}>
                    ...
                    <span style={{ color: C.gold, fontSize: 13, fontWeight: 600 }}>{t("blog.article1.cta")}</span>
                  </div>
                </article>
              ))}
            </div>
        ...
        <section style={{ paddingTop: 100, paddingBottom: 80 }}>
          <div style={{ maxWidth: 760, margin: "0 auto", padding: "0 40px" }}>
            <button onClick={() => { setActiveArticle(null); window.location.hash = ""; }} style={{
              ...
              onMouseLeave={e => { e.currentTarget.style.borderColor = C.bd1; e.currentTarget.style.color = C.gray2; }}>← {t("blog.viewAll")}</button>
            ...
            <div style={{ display: "flex", alignItems: "center", gap: 12, marginBottom: 20 }}>
              ...
              <span style={{ fontFamily: "'JetBrains Mono', monospace", fontSize: 12, color: C.gray }}>{current.readTime}</span>
            </div>
            ...
            <div style={{ marginTop: 48, padding: 28, background: C.navy3, border: `1px solid ${C.goldBorder}`, borderRadius: 16, display: "flex", alignItems: "center", gap: 20 }}>
              ...
              <div>
                ...
                <div style={{ fontSize: 13, color: C.gray }}>{t("pages.home.fondateur_acf_ai_consulting")}</div>
              </div>
            </div>

            {/* CTA */}
            <div style={{ marginTop: 32, padding: 32, background: C.navy2, border: `1px solid ${C.goldBorder}`, borderRadius: 16, textAlign: "center" }}>
              <h3 style={{ fontFamily: "'Space Grotesk', sans-serif", fontSize: 20, fontWeight: 700, marginBottom: 8 }}>{t("cta.description")}</h3>
              <p style={{ fontSize: 14, color: C.gray2, marginBottom: 20 }}>{t("pages.home.diagnostic_gratuit_en_10_minutes_score_immédiat_ra")}</p>
              <a href="https://www.acf-score.com/calculator" className="gold-glow" style={{ background: `linear-gradient(135deg, ${C.gold}, ${C.gold2})`, color: C.navy1, padding: "12px 24px", borderRadius: 10, fontSize: 14, fontWeight: 700, display: "inline-block", transition: "all .3s" }}>{t("pages.home.calculate_your_acf_score")} →</a>
            </div>
          </div>
        </section>
      )}
