...
.pc{background:var(--navy3);padding:52px 32px;transition:.3s;position:relative;overflow:hidden;display:flex;flex-direction:column}
...
.ptitle{font-family:'Space Grotesk',sans-serif;font-size:24px;font-weight:800;margin-bottom:14px;white-space:nowrap}
    ...
    <div id="cin-content" style="position:absolute;inset:0;z-index:10;display:flex;align-items:center;justify-content:center;flex-direction:column;text-align:center;padding:40px">
      ...
      <div class="cin-scene" id="cin-s7" style="opacity:0">
        ...
        <div style="text-align:center;margin-top:18px">
          <a href="/acf-whitepaper-${locale === 'fr' ? 'fr' : 'en'}.pdf" download="acf-whitepaper-${locale === 'fr' ? 'fr' : 'en'}.pdf" onclick="event.preventDefault();event.stopPropagation();var a=document.createElement('a');a.href='/acf-whitepaper-${locale === 'fr' ? 'fr' : 'en'}.pdf';a.download='acf-whitepaper-${locale === 'fr' ? 'fr' : 'en'}.pdf';a.target='_parent';window.parent.document.body.appendChild(a);a.click();a.remove()" style="color:#c9a84c;font-size:13px;text-decoration:underline;font-family:'Space Grotesk',sans-serif;opacity:.85;transition:.3s;cursor:pointer" onmouseover="this.style.opacity='1'" onmouseout="this.style.opacity='.85'">${locale === 'fr' ? 'T\u00e9l\u00e9charger le livre blanc \u2192' : 'Download the white paper \u2192'}</a>
        </div>
      </div>
