  ...
  fr: [
    ...
    /* ── TAB 4: ACF Score ── */
    {
      ...
      questions: [
        ...
        { q: "Combien de temps dure le diagnostic ACF Score ?", a: "Le diagnostic complet prend environ 15 à 20 minutes. Il se compose de questions structurées couvrant les 6 axes de gouvernance. Les résultats sont disponibles immédiatement avec un plan d'action détaillé et des recommandations prioritaires." },
  ...
  en: [
    ...
    /* ── TAB 4: ACF Score ── */
    {
      ...
      questions: [
        ...
        { q: "How long does the ACF Score diagnostic take?", a: "The complete diagnostic takes approximately 15 to 20 minutes with structured questions across all 6 governance axes. Results are available immediately with a detailed action plan and prioritized recommendations." },
